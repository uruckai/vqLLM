...
# 2. Install nvCOMP (official NVIDIA package)
echo "[2/6] Installing nvCOMP..."
cd /workspace
wget -q https://developer.download.nvidia.com/compute/nvcomp/5.0.0.6/local_installers/nvcomp-local-repo-ubuntu2404-5.0.0_5.0.0-1_amd64.deb
dpkg -i nvcomp-local-repo-ubuntu2404-5.0.0_5.0.0-1_amd64.deb
cp /var/nvcomp-local-repo-ubuntu2404-5.0.0.6/nvcomp-*-keyring.gpg /usr/share/keyrings/
apt-get update -qq
apt-get install -y -qq nvcomp
rm nvcomp-local-repo-ubuntu2404-5.0.0_5.0.0-1_amd64.deb
